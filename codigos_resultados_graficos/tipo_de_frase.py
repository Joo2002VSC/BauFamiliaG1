...
# Carregar dataset
df = pd.read_csv(r"C:\Users\joana\Desktop\Joana\Universidade\UMinho\HD\AVD\BauFamiliaG1\codigos_resultados_entrevistas\dataset_entrevistas.csv")

# Concatenar perguntas e respostas
texto = " ".join(df["Pergunta"].fillna("") + " " + df["Resposta"].fillna(""))
"C:\Users\joana\Desktop\Joana\Universidade\UMinho\HD\AVD\BauFamiliaG1\codigos_resultados_graficos\dataset_entrevistas.csv"
